...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  ...
  private:
    ...
    // code
    void RecvReverseRequest(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);
    // code
    /**
     * Receive RREP
     * \param p packet
     ...
     */
    // code
    void SendReverseRequest(const RreqHeader& rreqHeader, const RoutingTableEntry& toOrigin);
    // code
